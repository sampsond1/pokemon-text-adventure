...
namespace PokemonTextAdventure
{
    public partial class Methods
    {
        ...
        {
            locationdex.Add("palletTown", new Location("Pallet Town", "A small town with only a few buildings, Pallet Town is known for its simplicity. The biggest points of interest are Professor Oak's LAB, where he gave you your starter Pokémon, and your house [MY HOUSE]. Besides this, there's also another HOUSE, and a MAN and a WOMAN standing around outside. They might have something interesting to say. To the NORTH is an exit to Route 1, and to the SOUTH is Routh 21, a water route that needs a swimming Pokémon to access.", new Dictionary<string, string> { { "lab", "oaksLab" }, { "house", "bluesHouse" }, { "my house", "yourHouse" }, { "north", "route1" }, { "south", "route22" } }, new Dictionary<string, string> { }, new Dictionary<string, string> { { "man", "MAN: Wow, cool Pokémon! I'm raising Pokémon, too, so they can protect me!" }, { "woman", "WOMAN: You can tell when a place is enterable because it's name will be in all caps!" } }, false, ""));
